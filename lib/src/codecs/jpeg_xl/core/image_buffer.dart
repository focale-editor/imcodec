...
/// Stores one decoded image plane as integer or floating-point rows.
final class ImageBuffer {
  ...
  /// Rows containing int samples.
  List<Int32List>? _intRows;

  /// Rows containing float samples.
  List<Float32List>? _floatRows;

  /// Creates a plane backed by 32-bit integer samples.
  ...
  /// Creates a plane backed by 32-bit floating-point samples.
  ...
  /// Converts the plane to floating-point samples.
  ...
  /// Converts the plane to integer samples.
...
/// Allocates a zero-filled [height] by [width] floating-point matrix.
