...
final class GifEncoder extends RasterEncoder<GifEncodeOptions> {
  ...
  static _IndexedColorImage _quantizeIndexedColor(Image image, GifEncodeOptions options) {
    options.validate();
  ...
  static List<_ColorBox> _partitionColors(
  ...
  static Uint8List _mapWithoutDither(Image image, _PreparedHistogram prepared, _PaletteLookup lookup) {
  ...
  static Uint8List _mapWithDither(Image image, _PreparedHistogram prepared, GifEncodeOptions options, _PaletteLookup lookup) {
    final Uint8List indices = Uint8List(image.width * image.height);
  ...
  static int _roundedSixteenth(int value) => value >= 0 ? (value + 8) ~/ 16 : -((-value + 8) ~/ 16);
...
final class _IndexedColorImage {
  /// Width in pixels.
  final int width;
...
final class _PreparedHistogram {
  ...
  factory _PreparedHistogram.fromImage(Image image, GifEncodeOptions options) {
...
final class GifEncodeOptions extends RasterEncodeOptions {
